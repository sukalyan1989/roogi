    ...
    return (
      <div>
        ...
        <div>
          ...
          <a
            target="_blank"
            href="https://github.com/iniamudhan/react-bingmaps/blob/dev/src/App.js"
          >
            source
          </a>
        </div>
        ...
        <br />
        <h3>
          For new feature to be added, open new issue{" "}
          <a href="https://github.com/iniamudhan/react-bingmaps/issues/new">
            here
          </a>
          . Thanks
        </h3>
